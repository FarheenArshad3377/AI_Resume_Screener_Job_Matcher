  ...
  return (
    ...
    >
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <button className="rp-clear-link" onClick={onClearFilters}>
          Clear all
        </button>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="input-group mb-2">
          ...
          <input type="text" className="form-control" placeholder="City, State or Remote" />
        </div>
